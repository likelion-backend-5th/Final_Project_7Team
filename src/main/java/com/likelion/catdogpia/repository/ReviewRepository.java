...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    @Query("SELECT NEW com.likelion.catdogpia.domain.dto.mypage.ReviewDto(r.id, r.description, " +
    ...
    Page<ReviewDto> findAllByMemberId(Pageable pageable, @Param("memberId") Long memberId);
