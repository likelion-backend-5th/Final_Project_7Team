...
function searchConsultation() {
    ...
    window.location.href = '/admin/consultations?filter=' + filter + '&keyword=' + keyword
...
function navigateToPage(page) {
    ...
    if(hidden != null) {
        ...
        location.href = '/admin/consultations?page=' + page + '&filter=' + filter + '&keyword=' + hidden + '&fromDate=' + fromDate + '&toDate=' + toDate;
    } else if(keyword != null){
        filter = encodeURIComponent(filter);
        keyword = encodeURIComponent(keyword);
        location.href = '/admin/consultations?page=' + page + '&filter=' + filter + '&keyword=' + keyword + '&fromDate=' + fromDate + '&toDate=' + toDate;
    } else {
        location.href = '/admin/consultations?page=' + page;
    }
}
...
// qna삭제
async function deleteConsultationList() {
    let selectedItems = [];
    // 동작중일때 중복으로 동작하지 않도록
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (reissueResponse.ok) {
                    ...
                    await deleteConsultationList(); // 원래 요청을 다시 시도
                } else {
                    alert('토큰 재발급 실패');
                }
            }
